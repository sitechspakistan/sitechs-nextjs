...
const defaultIndustries = [
    { id: 1, icon: Stethoscope, color: "#A855F7", text: "Clinics & Healthcare" },
    { id: 2, iconClass: "fas fa-tooth", color: "#A855F7", text: "Dental Clinics" },
    { id: 3, icon: PawPrint, color: "#A855F7", text: "Veterinary Clinics" },
    { id: 4, icon: Utensils, color: "#A855F7", text: "Restaurants & Cafes" },
    { id: 5, icon: Scissors, color: "#A855F7", text: "Salons & Spas" },
    { id: 6, icon: Dumbbell, color: "#A855F7", text: "Gyms & Fitness" },
    { id: 7, icon: UserRound, color: "#A855F7", text: "Consultants & Coaches" },
    { id: 8, icon: Ellipsis, color: "#A855F7", text: "And Many More..." },
];
