const CaseStudyData = [
    ...
    },
    {
        ...
        seo: {
            metaTitle: "AI Email Automation for Follow-Ups | Sitechs",
            metaDescription: "Sitechs built an AI-powered Follow-Up Agent that automates customer reminders from Google Sheets — saving hours of manual work and improving customer satisfaction.",
        },
    ...
    },
    {
        ...
        seo: {
            metaTitle: "Hiller Media Group Website Redesign | Sitechs",
            metaDescription: "Sitechs redesigned Hiller Media Group's website with a modern WordPress build — improving load speed, SEO structure, and user engagement for their media brand.",
        },
        ...
        solution: ["We designed and developed a sleek, user-friendly WordPress website tailored to HMG's media-focused audience. The new site features an intuitive layout, optimized loading speed, and SEO-friendly structure — making it easier for visitors to explore their case-studies and connect with the brand."],
    ...
    },
    {
        ...
        image: "/assets/images/case-studies/5.jpg",
        seo: {
            metaTitle: "WhatsApp CRM Bot – Zoop AI Agent | Sitechs",
            metaDescription: "Sitechs built Zoop — a WhatsApp AI agent that connects directly to your CRM, letting customers create invoices, check payments, and manage tickets via simple chat messages.",
        },
    ...
    },
    {
        ...
        seo: {
            metaTitle: "Vezyon HR & Attendance Dashboard | Sitechs",
            metaDescription: "Sitechs developed a Laravel-based office management portal for Vezyon — integrating biometric attendance, shift scheduling, and HR operations into one powerful dashboard.",
        },
    ...
    },
    {
        ...
        image: "/assets/images/case-studies/4.jpg",
        seo: {
            metaTitle: "Upfeeds – Real-Time Upwork Job Alert Portal | Sitechs",
            metaDescription: "Sitechs built Upfeeds for Creative Triplet — a custom portal that monitors Upwork in real time and sends instant desktop alerts for relevant job postings, boosting response rates.",
        },
    ...
    },
    {
        ...
        image: "/assets/images/case-studies/csspatch.webp",
        seo: {
            metaTitle: "Custom Patch Hats eCommerce Store | Sitechs",
            metaDescription: "Sitechs designed and developed a fully responsive eCommerce store for Custom Patch Hats — featuring product categories, search, add-to-cart, and free shipping on orders over $250.",
        },
    ...
    },
    {
        ...
        image: "/assets/images/case-studies/ct.webp",
        seo: {
            metaTitle: "Creative Triplet – Next.js Website Rebuild | Sitechs",
            metaDescription: "Sitechs migrated Creative Triplet from Elementor to a custom Next.js website — drastically improving load speed, Core Web Vitals, and video performance for their explainer video agency.",
        },
        category: ["Website Development"],
    ...
    },
    {
        ...
        image: "/assets/images/case-studies/eh.webp",
        seo: {
            metaTitle: "EventsHub Dubai Brand Identity & Logo Design | Sitechs",
            metaDescription: "Sitechs created a bold bilingual brand identity for EventsHub Dubai — blending iconic Dubai landmarks, Arabic typography, and vibrant colors to capture the city's world-class events culture.",
        },
    ...
    },
    {
        ...
        image: "/assets/images/case-studies/inizio-website.webp",
        seo: {
            metaTitle: "Inizio Solutions – SEO-Optimized Next.js Website | Sitechs",
            metaDescription: "Sitechs built a high-performance Next.js website for Inizio Solutions, ranking them in 50+ cities across USA, UK, Australia & New Zealand for embroidery and custom patch keywords.",
        },
        category: ["Website Development"],
        title: "Inizio Solutions",
        deliverables: [["Next.js"], ["SEO"]],
        description: [
            "Inizio Solutions approached Sitechs to build a professional, high-performance website for their embroidery, vector art, and custom patches business. They needed a platform that not only looked great but also ranked well on search engines to attract new clients organically."
        ],
        solution: [
    ...
    {
        slug: "yfi-brand-logo",
        image: "/assets/images/case-studies/yfi-logo.webp",
        seo: {
            metaTitle: "Your Friend Infertility – Compassionate Brand Logo | Sitechs",
            metaDescription: "Sitechs crafted a warm, faith-inspired brand identity for Your Friend Infertility — a logo that communicates empathy, hope, and feminine strength for women navigating infertility.",
        },
    ...
    {
        slug: "yfi-website",
        image: "/assets/images/case-studies/yfi-website.webp",
        seo: {
            metaTitle: "Your Friend Infertility – WordPress Community Website | Sitechs",
            metaDescription: "Sitechs built a compassionate WordPress website for Your Friend Infertility — featuring stories of hope, a resource hub, devotionals, and a safe community space for women facing infertility.",
        },
