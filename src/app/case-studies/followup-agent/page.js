                ...
                <div className="row g-0">
                    <div className="col-xl-7">
                        ...
                        <div className="project-details-1-thumb mb-10">
                            <img src="/assets/images/case-study/1.jpg" alt="Automated AI Follow-Up Agent | Sitechs" />
                        </div>
                        <div className="project-details-1-thumb mb-10">
                            <img src="/assets/images/case-study/2.png" alt="Automated AI Follow-Up Agent | Sitechs" />
                        </div>
                        <div className="project-details-1-thumb mb-10">
                            <img src="/assets/images/case-study/3.png" alt="Automated AI Follow-Up Agent | Sitechs" />
                        </div>                           
                        </div>
                    </div>
                    <div className="col-xl-5">
                        ...
                        <div className="project-details-1-right p-relative">
                            <div className="project-details-1-title-box">
                                ...
                                <h4 className="project-details-1-title">Automated AI Follow-Up Agent</h4>
                                <p>A client came to Sitechs with a common challenge, missed
                                    follow-ups.</p>
                                    <p>They had a Google Sheet to track customers and an email
                                        inbox, but manually sending reminders was eating up
                                        valuable time.</p>
                            </div>
                            <div className="project-details-1-info-wrap">
                                <div className="project-details-1-info">
                                    <span>Client</span>
                                    <h4>Inizio Solutions</h4>
                                </div>
                                <div className="project-details-1-info">
                                    <span>Date</span>
                                    <h4>August '2025</h4>
                                ...
                                <div className="project-details-1-info">
                                    ...
                                    <h4>Automated AI Follow-Up Agent</h4>
                                </div>
                                <div className="project-details-1-info">
                                    <span>Our Solution</span>
                                    <h4>We built an AI-powered Follow-Up Agent that:</h4>
                                    <ul className="project-details-1-info-list">
                                ...
                                <p>The result? A more efficient follow-up process that saved the client hours of manual work.</p>
                            </div>
                                ...
                                <div className="project-details-1-social-inner">
                                    ...
                                    <span>
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M18 9C18 4.02943 13.9706 0 9 0C4.02943 0 0 4.02943 0 9C0 13.4922 3.29117 17.2155 7.59375 17.8907V11.6016H5.30859V9H7.59375V7.01719C7.59375 4.76156 8.93739 3.51562 10.9932 3.51562C11.9779 3.51562 13.0078 3.69141 13.0078 3.69141V5.90625H11.8729C10.7549 5.90625 10.4062 6.60001 10.4062 7.31174V9H12.9023L12.5033 11.6016H10.4062V17.8907C14.7088 17.2155 18 13.4922 18 9Z" fill="#19191A"/>
                                            <path d="M12.5072 11.6016L12.9062 9H10.4102V7.31174C10.4102 6.60001 10.7588 5.90625 11.8768 5.90625H13.0117V3.69141C13.0117 3.69141 11.9818 3.51562 10.9971 3.51562C8.94129 3.51562 7.59766 4.76156 7.59766 7.01719V9H5.3125V11.6016H7.59766V17.8907C8.05587 17.9626 8.5255 18 9.00391 18C9.48231 18 9.95195 17.9626 10.4102 17.8907V11.6016H12.5072Z" fill="white"/>
                                        </svg>
                                    </span>
                                    </a>
                                    <a href="#">
                        ...
                        <div className="project-details-1-navigation d-flex justify-content-between align-items-center">
                            <a className="project-details-1-prev" href="portfolio-details-1.html">
                            ...
                            <a className="project-details-1-next" href="portfolio-details-1.html">
                                <span>Next</span>
