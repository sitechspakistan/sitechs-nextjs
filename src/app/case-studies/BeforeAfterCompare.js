    ...
    <div className="work-ba">
      ...
      >
        <img
          ...
          className="work-ba__after"
          draggable={false}
        />
        <div className="work-ba__before-wrap" style={{ width: cmpPct }}>
          <img
            src="/assets/images/before-after/ct-before.png"
            alt="Creative Triplet website — before redesign"
            className="work-ba__before"
            style={{ width: cmpInner }}
            draggable={false}
          />
        </div>
        <div className="work-ba__handle" style={{ left: cmpPct }}>
          <span className="work-ba__handle-dot">⇄</span>
        </div>
        <span className="work-ba__pill work-ba__pill--before">Before</span>
        <span className="work-ba__pill work-ba__pill--after">After</span>
      </div>
    </div>
  );
}
