...
export default function AboutArea() {
    useGsapFade();
  return (
    <div className="tp-about-3-area pt-20 pb-110">
        <div className="container">
            <div className="row">
                ...
                <div className="tp-about-3-title-box">
                    <span className="tp-section-subtitle-2 tp_fade_bottom">
                        ...
                        <span className="tp-subtitle-text">Who we are</span>
                        <span>
                            <svg width="13" height="44" viewBox="0 0 13 44" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <h4 className="tp-section-title-90 tp_fade_bottom">Driving Innovation with AI Automations and Web</h4>
                </div>
                </div>
            </div>
            <div className="row align-items-center">
                ...
                <div className="tp-about-3-content">
                    <p className="mb-30 tp_fade_bottom">Sitechs is a full-service technology company specializing in AI automations, web, and mobile solutions.</p>
                    <p className="mb-45 tp_fade_bottom">We partner with startups and enterprises to build smart, scalable software that transforms ideas into reality.</p>                           
                </div>
                </div>
            </div>
        </div>
