                    ...
                    <div id="about-info" className="row">
                        {/* <div className="col-xxl-9">
                            <div className="ab-about-content p-relative">
                                ...
                                <p className="tp-dropcap tp_fade_bottom" style={{ translate: "none", rotate: "none", scale: "none", opacity: "1", transform: "translate(0px, 0px)" }}>
                            ...
                            <div className="row">
                                <div className="col-xl-5 col-lg-5 col-md-4 mb-40">
                                    <div className="ab-about-category-title-box p-relative">
                                        <h4 className="ab-about-category-title">Something <br /><span>WHAT I DO</span></h4>
                                        <img className="ab-about-shape-1 d-none d-md-block" src="/assets/images/shape-1.Webp" alt="shape" />
                                    </div>
                                </div>
                                <div className="col-xl-7 col-lg-7 col-md-8">
                                    <div className="row">
                                        <div className="col-xl-6 col-lg-6 col-md-6 mb-40">
                                            <div className="ab-about-category-list category-space-1 tp_fade_bottom" style={{ translate: "none", rotate: "none", scale: "none", opacity: "1", transform: "translate(0px, 0px)" }}>
                                                <ul>
                                                    <li>Art direction</li>
                                                    <li>Branding</li>
                                        ...
                                        <div className="col-xl-6 col-lg-6 col-md-6 mb-40">
                                            <div className="ab-about-category-list category-space-2 tp_fade_bottom" style={{ translate: "none", rotate: "none", scale: "none", opacity: "1", transform: "translate(0px, 0px)" }}>
                                                <ul>
