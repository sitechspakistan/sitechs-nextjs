...
export default function Hero() {
    ...
    //                         href="https://www.upwork.com/agencies/1863602840810539543/"
    //                         target="_blank"
    //                     >
    //                         Hire Us on{" "}
    //                         <img src="/assets/images/upwork.png" alt="Sitechs - Upwork" />
    //                     </a>
    ...
    //                         </li>
    //                         <li>
    //                             <a href="https://x.com/officialsitechs" target="_blank">
    ...
    useGsapReveal();
    return (
        <div className="tp-hero-3-area tp-hero-3-ptb hero-bg fix bg-hero">
            <div className="container">
                <div className="row ">
                    <div className="col-xl-12">
                        <div className="tp-hero-3-content-box text-center p-relative">
