        ...
        <div className="tp-offcanvas-wrapper">
          ...
          <div className="tp-offcanvas-main">            
              ...
              <div className="tp-offcanvas-contact">
                ...
                <ul>
                    <li><a href="tel:+92 342 3543100">+92 342 3543100</a></li>
                    <li><a href="mailto:hello@sitechs.co">hello@sitechs.co</a></li>
                ...
                <div className="row align-items-center">
                    <div className="col-xl-3 col-lg-6 col-md-6 col-6">
                      <div className="tp-header-logo tp-header-3-logo">
                          <Link className="logo-1" href="/"><img src="/assets/images/logo.png" alt="Sitechs"/></Link>
                          <Link className="logo-2" href="/"><img src="/assets/images/logo.png" alt="Sitechs"/></Link>
                      </div>
                    </div>
                    ...
                    <div className="col-xl-3 col-lg-6 col-md-6 col-6">                      
                      <div className="tp-header-3-right d-flex align-items-center justify-content-end">                        
                          <div className="tp-header-3-btn d-flex align-items-center ml-30">
                            <a className="tp-btn-border-sm d-none tp-btn-black-2 d-sm-block" href="https://calendar.app.google/Mog659g7KdYzSkga7" target="_blank">Book a Call</a>
                            <button className="ml-20 d-xl-none tp-header-3-bar tp-offcanvas-open-btn" onClick={openOffcanvas}><i className="fa-solid fa-bars"></i></button>
                          </div>
                      </div>
                    </div>
                </div>
